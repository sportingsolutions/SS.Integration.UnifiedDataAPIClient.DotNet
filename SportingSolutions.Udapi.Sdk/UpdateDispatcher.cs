...
//            //TODO: Refactor to include echoes
            
//            var connectMsg = new NewSubscriberMessage() { Subscriber = subscriber };
//            SdkActorSystem.ActorSystem.ActorSelection(SdkActorSystem.UpdateDispatcherPath).Tell(connectMsg);
...
//                SdkActorSystem.ActorSystem.ActorSelection(SdkActorSystem.UpdateDispatcherPath).Tell(disconnectMsg);
...
//            //check whether that's an echo message
...
//            SdkActorSystem.ActorSystem.ActorSelection(SdkActorSystem.UpdateDispatcherPath).Tell(new StreamUpdateMessage() { Id=consumerId, Message = message});
